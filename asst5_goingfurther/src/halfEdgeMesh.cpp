...
namespace CMU462 {
    ...
    void componentElementAddresses(HalfedgeIter h, string name) {
       cout  << name << endl
             << name + " halfedge: " << &( *h ) << endl
             << name + " next: " << elementAddress( h->next() ) << endl
             << name + " twin: " << elementAddress( h->twin() ) << endl
             << name + " vertex: " << elementAddress( h->vertex() ) << endl
             << name + " edge: " << elementAddress( h->edge() ) << endl
             << name + " face: " << elementAddress( h->face() ) << endl << endl ;
    }
